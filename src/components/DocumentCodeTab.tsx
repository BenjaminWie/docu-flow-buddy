          ...
          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div className="flex items-center gap-2 text-yellow-800">
              ...
              <span className="font-medium">
                Analyzing {functionsCount} complex functions across all repositories
              </span>
            </div>
            <p className="text-yellow-700 text-sm mt-1">
              Functions are ranked by combined complexity score using both rule-based analysis and LLM evaluation
            </p>
          </div>
        </CardContent>
      </Card>
